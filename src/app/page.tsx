...
export default function Home() {
  return (
    <main style={{ fontFamily: 'Georgia, serif', background: '#0a0a0b', color: '#e2ddd6', minHeight: '100vh' }}>
      ...
      {/* Hero */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', minHeight: '88vh', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>

        {/* Left */}
        <div style={{ padding: 'clamp(2rem,5vw,5rem) clamp(1.5rem,4vw,3rem)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
          <div>
            <div style={{ fontFamily: 'system-ui,sans-serif', fontSize: '0.7rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#6b6860', marginBottom: '2rem' }}>
              a safe space to feel
            </div>
            <h1 style={{ fontSize: 'clamp(2.2rem,5vw,4.2rem)', fontWeight: 400, lineHeight: 1.1, letterSpacing: '-0.02em', color: '#e2ddd6', marginBottom: '1.5rem' }}>
              You don{"'"}t have<br />to carry this<br />
              <em style={{ color: '#c9a96e', fontStyle: 'italic' }}>alone.</em>
            </h1>
            <p style={{ fontFamily: 'system-ui,sans-serif', fontSize: '0.88rem', color: '#6b6860', lineHeight: 1.7, maxWidth: '380px' }}>
          ...
          <div style={{ fontFamily: 'system-ui,sans-serif', fontSize: '0.7rem', color: '#3a3835', letterSpacing: '0.06em', textTransform: 'uppercase', marginTop: '3rem' }}>
            Anonymous · No account needed · Not saved
          </div>
        </div>

        {/* Right */}
        <div style={{ padding: 'clamp(2rem,5vw,5rem) clamp(1.5rem,4vw,3rem)', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '2rem' }}>
          {[
          ...
          <div style={{ display: 'flex', gap: '2rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.06)', flexWrap: 'wrap' }}>
            {[
      ...
      {/* Bottom strip */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'clamp(1.5rem,3vw,2rem) clamp(1.5rem,3vw,3rem)', gap: '1rem', flexWrap: 'wrap' }}>
